...
class ScanMatcher{
	public:
		...
		double registerPoint(ScanMatcherMap& map, double registerPoint_x_meter, double registerPoint_y_meter, bool is_occupied);
		...
		void computeActivePoint(ScanMatcherMap& map, double ActivePoint_x_meter, double ActivePoint_y_meter);
