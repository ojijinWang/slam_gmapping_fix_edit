...
//	protected:
		...
		Storage m_storage;			// as the usage of child class, Storage = HierarchicalArray2D<Cell>
		int m_mapSizeX, m_mapSizeY;
		int m_sizeX2, m_sizeY2;
	static const Cell m_unknown;			// as the usage of child class, Cell = PointAccumulator
};
